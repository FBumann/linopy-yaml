...
| `operators/` | one minimal model per operator in [the operator reference](https://math-spec.readthedocs.io/latest/reference/language/operators/), which is where the math on that page comes from |
