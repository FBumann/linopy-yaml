...
| `operators/` | one minimal model per operator in [the operator reference](https://energy-models.github.io/math-spec/reference/language/operators), which is where the math on that page comes from |
