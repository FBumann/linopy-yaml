...
# ///
"""Reference for ``pypsa_ac_dc``: PyPSA's own meshed AC-DC example. See docs/models/index.md.

    uv run --script examples/ports/references/pypsa/pypsa_ac_dc.py
