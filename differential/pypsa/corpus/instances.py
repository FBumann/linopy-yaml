...
file — the parity and model-for-model stamps — is written by `parity.py` one
directory up, and the `PyPSA parity` workflow fails when the committed
certificate is not what this tree produces.
"""
