...
> ✔ Verified against pypsa 1.3.0 — objective **8785.0** on both sides; ✔ 64 rows · 20 columns; ✔ 64 rows; objective only — `lpspec.linopy` stops at `ValueError: cannot reshape array of size 0 into shape (4,0,newaxis)`.
