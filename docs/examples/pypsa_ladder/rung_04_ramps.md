...
> ✔ Verified against pypsa 1.3.0 — objective **8785.0** on both sides; ✔ 64 rows · 20 columns; prices agree on 12 rows; **model for model**: 8 blocks equal, 4 documented splits.
