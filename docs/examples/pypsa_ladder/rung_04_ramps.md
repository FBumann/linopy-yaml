...
> ✔ Verified against pypsa 1.3.0 — objective **8785.0** on both sides; structure ✔ 9 rows · 2 columns, name for name; size ✔ 64 rows · ✔ 20 columns · ✔ 92 nonzeros; duals ✔ 64 rows; **model for model**: 8 blocks equal, 4 documented splits.
