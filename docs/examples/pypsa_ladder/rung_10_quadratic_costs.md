...
> ✔ Verified against pypsa 1.3.0 — objective **12587.437500000098** on both sides; structure ✔ 5 rows · 2 columns, name for name; size ✔ 60 rows · ✔ 24 columns · ✔ 80 nonzeros; duals ✔ 60 rows; **model for model**: 8 blocks equal, 0 documented splits.
