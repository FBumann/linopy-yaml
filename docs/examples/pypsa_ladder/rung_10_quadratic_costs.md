...
=== "lpspec"
    ...
    objective:
      ...
      expression: sum(Generator_p * Generator_marginal_cost * snapshot_weightings_objective) + sum(Generator_p
        * Generator_p * Generator_marginal_cost_quadratic * snapshot_weightings_objective) + sum(Link_p *
        Link_marginal_cost * snapshot_weightings_objective) + sum(Link_p * Link_p * Link_marginal_cost_quadratic
        * snapshot_weightings_objective)
    ```
