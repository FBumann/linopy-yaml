...
One rung of [the PyPSA corpus](https://math-spec.readthedocs.io/en/latest/examples/pypsa/#rung-16): the file `pypsa.yaml` projected onto what this network builds, bound to that network, and held to what PyPSA solves it to.
...
=== "lpspec"
    ...
    The model, `differential/pypsa/rungs/rung_16_link_delay.yaml` — the file projected onto what this rung builds:
