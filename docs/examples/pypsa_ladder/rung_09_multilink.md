...
> ✔ Verified against pypsa 1.3.0 — objective **11700.0** on both sides; structure ✔ 5 rows · 2 columns, name for name; size ✔ 68 rows · ✔ 24 columns · ✔ 84 nonzeros; duals ✔ 68 rows; **model for model**: 8 blocks equal, 0 documented splits.
