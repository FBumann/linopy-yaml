...
> ✔ Verified against pypsa 1.3.0 — objective **11700.0** on both sides; ✔ 68 rows · 24 columns; ✔ 68 rows; objective only — `lpspec.linopy` stops at `ValueError: cannot reshape array of size 0 into shape (4,0,newaxis)`.
