...
> ✔ Verified against pypsa 1.3.0 — objective **11700.0** on both sides; ✔ 68 rows · 24 columns; prices agree on 20 rows; **model for model**: 8 blocks equal, 0 documented splits.
