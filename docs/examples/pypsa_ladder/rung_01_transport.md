...
> ✔ Verified against pypsa 1.3.0 — objective **7182.222222222221** on both sides; ✔ 45 rows · 16 columns; ✔ 45 rows; objective only — `lpspec.linopy` stops at `ValueError: cannot reshape array of size 0 into shape (4,0,newaxis)`.
