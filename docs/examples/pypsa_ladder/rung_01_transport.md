...
> ✔ Verified against pypsa 1.3.0 — objective **7182.222222222221** on both sides; ✔ 45 rows · ✔ 16 columns · ✔ 57 nonzeros; ✔ 45 rows; **model for model**: 10 blocks equal, 0 documented splits.
