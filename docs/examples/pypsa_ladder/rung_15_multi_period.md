...
One rung of [the PyPSA corpus](https://math-spec.readthedocs.io/en/latest/examples/pypsa/#rung-15): the file `pypsa.yaml` projected onto what this network builds, bound to that network, and held to what PyPSA solves it to.
...
=== "lpspec"
    ...
    The model, `differential/pypsa/rungs/rung_15_multi_period.yaml` — the file projected onto what this rung builds:
...
The tables this rung is the first to declare (34), as the binding produced them:
