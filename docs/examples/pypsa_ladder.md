...
48 tables bound non-empty, 0 of them first fed by this rung and shown here; the rest were first fed by a lower rung and grow with the network.
...
64 tables bound non-empty, 16 of them first fed by this rung and shown here; the rest were first fed by a lower rung and grow with the network.
...
46 tables bound non-empty, 2 of them first fed by this rung and shown here; the rest were first fed by a lower rung and grow with the network.
...
22 tables bound non-empty, 22 of them first fed by this rung and shown here; the rest were first fed by a lower rung and grow with the network.
