...
[`piecewise:`](https://math-spec.readthedocs.io/latest/reference/language/piecewise/) cannot say that: its `links:`
...
| on one segment | [`sos:`](https://math-spec.readthedocs.io/latest/reference/language/piecewise/#sos) `type: 2` over that variable |
...
exist, and an [`sos:`](https://math-spec.readthedocs.io/latest/reference/language/piecewise/#sos) set is over the
