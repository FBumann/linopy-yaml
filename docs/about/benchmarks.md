...
[the ceiling](https://math-spec.readthedocs.io/latest/about/ceiling/#capability-is-not-the-ceiling); the plan is
...
([sos](https://math-spec.readthedocs.io/latest/reference/language/piecewise/#sos)) ships to every sink, natively where the row says
...
rather than papering over it ([the ceiling](https://math-spec.readthedocs.io/latest/about/ceiling/#capability-is-not-the-ceiling)).
