...
laws ([the ten rules](https://math-spec.readthedocs.io/en/latest/reference/language/#ten-rules-the-language-reduces-to)). Their math is also the corpus we score
