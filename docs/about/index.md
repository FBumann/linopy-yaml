...
[the guide](../guide.md) and [the reference](https://math-spec.readthedocs.io/latest/reference/language/).

| | |
|---|---|
| [Architecture](architecture.md) | the thesis, the hard rules, the lane from YAML to solver, and the module map |
| [The ceiling](https://math-spec.readthedocs.io/latest/about/ceiling/) | what the language deliberately cannot say, and what that buys |
