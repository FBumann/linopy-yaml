"""The typeset shell front — `python -m lpspec <format> model.yaml`.
...
def test_the_shell_front_costs_no_dependency():
    ...
    would be worse than stdlib, because `python -m lpspec latex` would stop
    ...
    assert roots <= sys.stdlib_module_names | {'lpspec'}, f'the shell front grew a dependency: {roots}'
