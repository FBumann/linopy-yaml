"""The typeset shell front — `python -m charter <format> model.yaml`.
...
from charter import __main__ as front
from charter.typeset import FORMATS
...
def test_the_shell_front_costs_no_dependency():
    ...
    would be worse than stdlib, because `python -m charter latex` would stop
    ...
    assert roots <= sys.stdlib_module_names | {'charter'}, f'the shell front grew a dependency: {roots}'
