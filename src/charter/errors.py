...
subclasses :class:`CharterError`, which subclasses ``ValueError``.
...
class LanguageError(CharterError):
...
class DataError(CharterError):
    """Data bound to a valid model is missing or the wrong shape."""


class NoSolutionError(CharterError):
