...
than remembering what :func:`build` saw::
    ...
    m = charter_linopy.build('model.yaml', data={...})
    charter_linopy.extend(m, 'ramp_constraint.yaml', data={...})
    m.solve(...)
    charter_linopy.expression(m, 'model.yaml', 'co2', data={...})
...
try:
    ...
    msg = 'The linopy compatibility layer requires the [linopy] extra: pip install "charter[linopy]"'
    raise ModuleNotFoundError(msg) from exc


from charter._notes import note
from charter.errors import LanguageError, unknown_name_message
from charter.language.expression_parser import ComparisonNode
...
from charter.linopy.builder import EvaluationContext, _eval_ast, build_model
from charter.linopy.loader import (
    build_dim_coords,
    build_master_coords,
    dim_index_of,
    load_parameters,
)
from charter.sources import validate_piecewise_data
