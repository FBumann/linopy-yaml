...
:class:`~charter.relational.plan.Program`. It lives on the language side, so the
engine subpackage stays free of YAML knowledge and this module never imports
the eager builder.

Constructs with no lowering raise :class:`~charter.errors.LanguageError` naming
...
from charter.language import degree
...
from charter.language.operators import call_shape_error, edge_error
from charter.language.piecewise import expand_piecewise
from charter.language.resolution import Namespace, expression_of, where_of
from charter.language.where_parser import (
    AndNode,
    BooleanLiteralNode,
