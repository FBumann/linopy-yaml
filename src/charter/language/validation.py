...
from charter.errors import SchemaError, schema_error
from charter.language._yaml import read_yaml
from charter.language.dimensions import check_schema
from charter.language.expansion import expand, parse_and_expand, parse_template
from charter.language.expression_parser import (
    ArithmeticNode,
    BinaryOperatorNode,
    ComparisonNode,
    CoordinateNode,
...
from charter.language.operators import BUILTINS, unknown_operator_message
from charter.language.resolution import Namespace, resolve_expression, resolve_where
from charter.language.where_parser import parse_where
    ...
    *,
    ...
    Args:
        ...
        known_variables: Variables the file may reference without declaring,
            mapped to their dims — what ``charter.linopy.extend`` passes for an
