...
and not three formulations (:data:`~charter.language.model.PIECEWISE_METHODS`).
...
degree-checked, dims from :mod:`~charter.language.dimensions` — which keeps
...
*values*, so it needs data and lives in :mod:`charter.sources`.
"""
...
from charter.errors import LanguageError, PiecewiseExpansionError
from charter.language.degree import check_expression
from charter.language.dimensions import dims_of
from charter.language.expression_parser import ComparisonNode, parse_expression
from charter.language.model import Model, PiecewiseBlock
from charter.language.resolution import Namespace, resolve_expression
