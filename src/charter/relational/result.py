...
from charter.errors import CharterError, NoSolutionError, unknown_name_message
...
def tidy_to_pandas(frame: pl.DataFrame) -> pd.DataFrame:
    ...
    :class:`~charter.strategy.Runs`, which differ only in where the tidy frame
...
class Diagnostics:
    ...
    #: (:mod:`charter.relational.sinks.sos`), which is the one thing that grows
    ...
    #: an iterating driver is the difference between "charter is slow" and
...
class Result:
    ...
    reading values, or catch :class:`~charter.errors.NoSolutionError`. The
    ...
    def primal(self, name: str) -> pl.DataFrame:
        ...
        Raises:
            ...
            CharterError: The model was rebound after this solve.
    ...
    def dual(self, name: str) -> pl.DataFrame:
        ...
        Raises:
            ...
            CharterError: It left primals but no duals — an integer variable
        ...
        if self._no_duals is not None:
            raise CharterError(self._no_duals)
    ...
    def activity(self, name: str) -> pl.DataFrame:
        ...
        Raises:
            NoSolutionError: The solve left no values to read.
            CharterError: This result was closed.
            KeyError: No constraint is called *name*.
        """
    ...
    def close(self) -> None:
        ...
        :class:`~charter.api.BoundModel`'s to close: a result closed on the way
