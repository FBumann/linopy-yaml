...
from charter.relational.engines.polars.compiler import UNIT, ordinal, predicate_dims

if TYPE_CHECKING:
    from collections.abc import Callable, Sequence

    from charter.relational import plan
    from charter.relational.engines.polars.compiler import PolarsCompiler, Presence
...
def row_major(compiler: PolarsCompiler, dims: tuple[str, ...], ordinals: Callable[[str], pl.Expr]) -> pl.Expr:
    ...
    *ordinals* says how the frame in hand carries a dim's ordinal, which is
    ...
    :meth:`~charter.relational.engines.polars.compiler.PolarsCompiler.ordinal_of`.
