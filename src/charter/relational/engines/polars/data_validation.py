...
The lanes share the *wording* (`charter/errors.py`) and the *contract* —
...
from charter.errors import DataError, duplicate_coordinate_message, unknown_labels_message
