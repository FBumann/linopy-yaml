...
nothing about the syntax; a :class:`~charter.typeset.format.Format` decides only
...
:class:`~charter.typeset.symbols.SymbolTable` (``--symbols``) makes it
...
or from a shell::
    ...
    python -m charter latex model.yaml --symbols model.symbols.yaml --standalone -o model.tex
    python -m charter typst model.yaml --standalone -o model.typ
"""
...
from charter.typeset.latex import LatexFormat
from charter.typeset.markdown import MarkdownFormat
from charter.typeset.symbols import Symbols, SymbolTable
from charter.typeset.typst import TypstFormat
from charter.typeset.walk import Walk
...
def typeset(
    ...
    *,
    ...
    Args:
        model: Anything :func:`charter.load_model` accepts.
