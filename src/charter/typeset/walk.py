...
from charter.language.resolution import expression_of, where_of
...
from charter.typeset.format import Entry, Glossary, Line

if TYPE_CHECKING:
    import datetime

    from charter.language.model import Model, SosBlock
    from charter.language.resolution import Namespace
    from charter.typeset.format import Format
    from charter.typeset.symbols import Symbols
