...
:mod:`charter.relational.frames`, so no dataframe library beyond the engine's
...
from charter.errors import DataError, PiecewiseExpansionError
from charter.relational.frames import as_frame, labels_frame
    ...
    for name, pw in schema.piecewise.items():
        ...
        try:
            ...
            msg = (
                ...
                f'requires xarray — pip install "charter[linopy]" '
