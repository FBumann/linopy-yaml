...
def typeset(
    ...
    *,
    ...
    Args:
        ...
        fmt: The format to spell the math in — one of :data:`FORMATS`.
        symbols: A :class:`SymbolTable` as a path, a mapping or the object,
            saying how names print. Everything it does not name is derived.
