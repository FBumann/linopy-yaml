...
time. The pass that needs it — the solver hand-off, reaching it through
:class:`~lpspec.relational.sinks.tables.ModelTables` — walks two kinds of
unit, and they differ only in width: a row costs its average nonzeros, a
column costs one.
